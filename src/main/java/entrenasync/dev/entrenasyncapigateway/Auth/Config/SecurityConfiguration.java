    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity httpSecurity) {
        return httpSecurity
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.POST,"/Exercises").hasAnyRole("admin", "Worker")
                        .pathMatchers(HttpMethod.DELETE,"/Exercises/{id}").hasAnyRole("admin", "Worker")
                        .pathMatchers(HttpMethod.PUT,"/Exercises/{id}").hasAnyRole("admin", "Worker")
                        .pathMatchers(HttpMethod.GET,"/Exercises/{id}").permitAll()
                        .pathMatchers(HttpMethod.GET,"/Exercises").permitAll()
                        .pathMatchers(HttpMethod.GET, "/Exercises/all").permitAll()
                        ...
                        .pathMatchers( HttpMethod.GET,"/Clients/all").hasAnyRole("admin", "Worker")
                        ...
                        .pathMatchers(HttpMethod.DELETE, "services/{id}").hasAnyRole("admin", "Client", "Worker")
